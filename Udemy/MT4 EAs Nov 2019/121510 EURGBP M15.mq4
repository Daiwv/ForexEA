...
static input double Maximum_Amount  = 0.03; // Maximum position amount [lot]
static input double Adding_Amount   = 0.01; // Amount to add on addition [lot]
static input double Reducing_Amount = 0.01; // Amount to close on reduction [lot]
...
input int Slot0IndParam0 = 8; // Tenkan
input int Slot0IndParam2 = 30; // Kijun
input int Slot0IndParam4 = 60; // Senkou Span B
static input string IndicatorName1 = "Commodity Channel Index"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 100; // Smoothing period
input int Slot1IndParam1 = 100; // Level
input double Slot1IndParam2 = 0.015; // Multiplier
static input string IndicatorName2 = "Commodity Channel Index"; // ------ Indicator parameters ------
input int Slot2IndParam0 = 90; // Smoothing period
input int Slot2IndParam1 = 100; // Level
input double Slot2IndParam2 = 0.015; // Multiplier
static input string IndicatorName3 = "Commodity Channel Index"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 80; // Smoothing period
input int Slot3IndParam1 = 100; // Level
input double Slot3IndParam2 = 0.015; // Multiplier
static input string IndicatorName4 = "Stop Limit"; // ------ Indicator parameters ------
input int Slot4IndParam0 = 850; // Stop Loss
input int Slot4IndParam1 = 810; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 7101744; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.Description            = "Exported on 07/11/2019 from Forex Strategy Builder Professional, v3.8.8";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 103;
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter the market at Tenkan Sen";
   ...
   strategy.Slot[1].IndicatorName    = "Commodity Channel Index";
   ...
   strategy.Slot[1].IndicatorPointer = indicatorManager.CreateIndicator("Commodity Channel Index", SlotTypes_OpenFilter);
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "CCI rises";
   ...
   strategy.Slot[1].IndicatorPointer.NumParam[2].Caption = "Multiplier";
   ...
   strategy.Slot[2].IndicatorName    = "Commodity Channel Index";
   ...
   strategy.Slot[2].IndicatorPointer = indicatorManager.CreateIndicator("Commodity Channel Index", SlotTypes_OpenFilter);
   ...
   strategy.Slot[2].IndicatorPointer.ListParam[0].Text    = "CCI rises";
   ...
   strategy.Slot[3].IndicatorName    = "Commodity Channel Index";
   ...
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("Commodity Channel Index", SlotTypes_OpenFilter);
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "CCI rises";
   ...
   strategy.Slot[3].IndicatorPointer.NumParam[0].Caption = "Smoothing period";
   ...
   strategy.Slot[3].IndicatorPointer.NumParam[2].Caption = "Multiplier";
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName>Forex Strategy Builder Professional</programName><programVersion>v3.8.8</programVersion><strategyName>121510 Ichimoku + 3 CCI</strategyName><profileName>Default profile</profileName><dataSourceName>JFD MetaTrader 4</dataSourceName><instrumentSymbol>EURGBP</instrumentSymbol><instrumentPeriod>15</instrumentPeriod><sameDirSignalAction>Add</sameDirSignalAction><oppDirSignalAction>Nothing</oppDirSignalAction><maxOpenLots>0.03</maxOpenLots><useAccountPercentEntry>False</useAccountPercentEntry><entryLots>0.01</entryLots><addingLots>0.01</addingLots><reducingLots>0.01</reducingLots><useMartingale>False</useMartingale><martingaleMultiplier>2</martingaleMultiplier><description>Exported on 07/11/2019 from Forex Strategy Builder Professional, v3.8.8</description><recommendedBars>1000</recommendedBars><openFilters>3</openFilters><closeFilters>0</closeFilters><firstBar>103</firstBar><minBarsRequired>104</minBarsRequired><permanentStopLoss usePermanentSL=\"False\" permanentSLType=\"Relative\">825</permanentStopLoss><permanentTakeProfit usePermanentTP=\"False\" permanentTPType=\"Relative\">915</permanentTakeProfit><breakEven useBreakEven=\"False\">1000</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Ichimoku Kinko Hyo</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Enter the market at Tenkan Sen</value></listParam><numParam paramNumber=\"0\"><caption>Tenkan</caption><value>8</value></numParam><numParam paramNumber=\"2\"><caption>Kijun</caption><value>30</value></numParam><numParam paramNumber=\"4\"><caption>Senkou Span B</caption><value>60</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"1\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Commodity Channel Index</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>CCI rises</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>Smoothing period</caption><value>100</value></numParam><numParam paramNumber=\"1\"><caption>Level</caption><value>100</value></numParam><numParam paramNumber=\"2\"><caption>Multiplier</caption><value>0.015</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"2\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Commodity Channel Index</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>CCI rises</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>Smoothing period</caption><value>90</value></numParam><numParam paramNumber=\"1\"><caption>Level</caption><value>100</value></numParam><numParam paramNumber=\"2\"><caption>Multiplier</caption><value>0.015</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"3\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Commodity Channel Index</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>CCI rises</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>Smoothing period</caption><value>80</value></numParam><numParam paramNumber=\"1\"><caption>Level</caption><value>100</value></numParam><numParam paramNumber=\"2\"><caption>Multiplier</caption><value>0.015</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M15</indicatorPeriod></slot><slot slotNumber=\"4\" slotType=\"Close\"><indicatorName>Stop Limit</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Exit at Stop Loss or at Take Profit</value></listParam><numParam paramNumber=\"0\"><caption>Stop Loss</caption><value>850</value></numParam><numParam paramNumber=\"1\"><caption>Take Profit</caption><value>810</value></numParam></slot></strategy> */
//+------------------------------------------------------------------+
