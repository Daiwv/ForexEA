...
input int Stop_Loss   = 90; // Stop Loss (pips)
input int Take_Profit = 85; // Take Profit (pips)
...
input int Ind1Param1 = 80; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 01027602; // Magic Number
...
void ManageClose()
  {
   double ind1val1 = iRSI(NULL,0,Ind1Param0,PRICE_CLOSE,1);
   double ind1val2 = iRSI(NULL,0,Ind1Param0,PRICE_CLOSE,2);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET JFD-Demo; GBPJPY; M5 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":90,"takeProfit":85,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Bollinger Bands","listIndexes":[1,3,0,0,0],"numValues":[20,2,0,0,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[4,3,0,0,0],"numValues":[10,80,0,0,0,0]}]} */
