...
input int Stop_Loss   = 700; // Stop Loss [point]
input int Take_Profit = 400; // Take Profit [point]
input int Break_Even  = 0; // Break Even [point]
static input double Martingale_Multiplier = 0; // Martingale Multiplier

static input string IndicatorName0 = "Bollinger Bands"; // ------ Indicator parameters ------
input int Slot0IndParam0 = 40; // MA period
input double Slot0IndParam1 = 2; // Multiplier
static input string IndicatorName1 = "Moving Averages Crossover"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 45; // Fast MA period
input int Slot1IndParam1 = 95; // Slow MA period
input int Slot1IndParam2 = 0; // Fast MA shift
input int Slot1IndParam3 = 0; // Slow MA shift
static input string IndicatorName2 = "MACD"; // ------ Indicator parameters ------
input int Slot2IndParam0 = 26; // Slow MA period
...
input int Slot3IndParam0 = 26; // Slow MA period
...
static input int Expert_Magic = 5212453; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "100130601 EURUSD M1";
   ...
   strategy.Description            = "Exported on 05/10/2019 from Forex Strategy Builder Professional, v3.8.8";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 43;
   strategy.MinBarsRequired        = 99;
   ...
   strategy.Slot[0].IndicatorName    = "Bollinger Bands";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Bollinger Bands", SlotTypes_Open);
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter long at Lower Band";
   ...
   strategy.Slot[0].IndicatorPointer.NumParam[1].Caption = "Multiplier";
   ...
   strategy.Slot[1].IndicatorPeriod  = DataPeriod_M30;
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[0].Index   = 2;
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "Fast MA is higher than Slow MA";
   strategy.Slot[1].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[1].IndicatorPointer.ListParam[1].Caption = "Base price";
   strategy.Slot[1].IndicatorPointer.ListParam[1].Index   = 3;
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[4].Index   = 0;
   strategy.Slot[1].IndicatorPointer.ListParam[4].Text    = "Simple";
   ...
   strategy.Slot[2].IndicatorPointer.ListParam[0].Index   = 10;
   strategy.Slot[2].IndicatorPointer.ListParam[0].Text    = "MACD line is higher than the Signal line";
   ...
   strategy.Slot[3].IndicatorPeriod  = DataPeriod_H1;
   ...
   strategy.Slot[4].IndicatorName    = "Close and Reverse";
   ...
   strategy.Slot[4].IndicatorPointer = indicatorManager.CreateIndicator("Close and Reverse", SlotTypes_Close);
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[0].Text    = "Close all positions and open a new one in the opposite direction";
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName>Forex Strategy Builder Professional</programName><programVersion>v3.8.8</programVersion><strategyName>100130601 EURUSD M1</strategyName><profileName>Default profile</profileName><dataSourceName>JFD MetaTrader 4</dataSourceName><instrumentSymbol>EURUSD</instrumentSymbol><instrumentPeriod>1</instrumentPeriod><sameDirSignalAction>Add</sameDirSignalAction><oppDirSignalAction>Reverse</oppDirSignalAction><maxOpenLots>0.03</maxOpenLots><useAccountPercentEntry>False</useAccountPercentEntry><entryLots>0.01</entryLots><addingLots>0.01</addingLots><reducingLots>0.01</reducingLots><useMartingale>False</useMartingale><martingaleMultiplier>2</martingaleMultiplier><description>Exported on 05/10/2019 from Forex Strategy Builder Professional, v3.8.8</description><recommendedBars>1000</recommendedBars><openFilters>3</openFilters><closeFilters>0</closeFilters><firstBar>43</firstBar><minBarsRequired>99</minBarsRequired><permanentStopLoss usePermanentSL=\"True\" permanentSLType=\"Relative\">700</permanentStopLoss><permanentTakeProfit usePermanentTP=\"True\" permanentTPType=\"Relative\">400</permanentTakeProfit><breakEven useBreakEven=\"False\">1000</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Bollinger Bands</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>1</index><value>Enter long at Lower Band</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>MA period</caption><value>40</value></numParam><numParam paramNumber=\"1\"><caption>Multiplier</caption><value>2.00</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"1\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Moving Averages Crossover</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>2</index><value>Fast MA is higher than Slow MA</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Fast MA method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"4\"><caption>Slow MA method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Fast MA period</caption><value>45</value></numParam><numParam paramNumber=\"1\"><caption>Slow MA period</caption><value>95</value></numParam><numParam paramNumber=\"2\"><caption>Fast MA shift</caption><value>0</value></numParam><numParam paramNumber=\"3\"><caption>Slow MA shift</caption><value>0</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M30</indicatorPeriod></slot><slot slotNumber=\"2\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>10</index><value>MACD line is higher than the Signal line</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>26</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M30</indicatorPeriod></slot><slot slotNumber=\"3\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>10</index><value>MACD line is higher than the Signal line</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>26</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>H1</indicatorPeriod></slot><slot slotNumber=\"4\" slotType=\"Close\"><indicatorName>Close and Reverse</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Close all positions and open a new one in the opposite direction</value></listParam></slot></strategy> */
//+------------------------------------------------------------------+
