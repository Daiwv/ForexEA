...
input int Stop_Loss   = 550; // Stop Loss [point]
...
input int Slot4IndParam0 = 30; // Slow MA period
...
input int Slot5IndParam0 = 700; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 5212307; // Expert Magic Number
