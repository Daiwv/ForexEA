...
input int Stop_Loss   = 650; // Stop Loss [point]
...
input int Slot0IndParam0 = 50; // Period
input int Slot0IndParam1 = 0; // Shift
static input string IndicatorName1 = "Vidya Moving Average"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 30; // Period
input int Slot1IndParam1 = 80; // Smooth
static input string IndicatorName2 = "Moving Averages Crossover"; // ------ Indicator parameters ------
input int Slot2IndParam0 = 2; // Fast MA period
input int Slot2IndParam1 = 18; // Slow MA period
...
input int Slot3IndParam0 = 24; // Slow MA period
...
input int Slot4IndParam0 = 36; // Slow MA period
input int Slot4IndParam1 = 12; // Fast MA period
input int Slot4IndParam2 = 9; // Signal line period
static input string IndicatorName5 = "Take Profit"; // ------ Indicator parameters ------
input int Slot5IndParam0 = 750; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 5212834; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "300130243 USDJPY M1";
   ...
   strategy.FirstBar               = 113;
   strategy.MinBarsRequired        = 114;
   ...
   strategy.Slot[1].IndicatorName    = "Vidya Moving Average";
   ...
   strategy.Slot[1].IndicatorPointer = indicatorManager.CreateIndicator("Vidya Moving Average", SlotTypes_OpenFilter);
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "The Vidya Moving Average rises";
   ...
   strategy.Slot[1].IndicatorPointer.NumParam[1].Caption = "Smooth";
   ...
   strategy.Slot[5].IndicatorName    = "Take Profit";
   ...
   strategy.Slot[5].IndicatorPointer = indicatorManager.CreateIndicator("Take Profit", SlotTypes_Close);
   ...
   strategy.Slot[5].IndicatorPointer.ListParam[0].Text    = "Exit at Take Profit level";

   strategy.Slot[5].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[5].IndicatorPointer.NumParam[0].Caption = "Take Profit";
